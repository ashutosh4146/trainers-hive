...
export async function sendOtpEmail(to: string, otp: string): Promise<void> {
  ...
  const html = `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#f9fafb;border-radius:12px"><span style="font-size:22px;font-weight:700;color:#0f766e">Trainers Hive</span><h2 style="margin:16px 0 8px;font-size:20px;color:#111827">Your verification code</h2><p style="margin:0 0 24px;color:#6b7280;font-size:15px">Use the code below to verify your email. It expires in <strong>10 minutes</strong>.</p><div style="background:#fff;border:2px solid #e5e7eb;border-radius:10px;padding:20px;text-align:center;margin-bottom:24px"><span style="font-size:40px;font-weight:700;letter-spacing:12px;color:#0f766e">${otp}</span></div><p style="margin:0;color:#9ca3af;font-size:13px">If you did not request this code, ignore this email.</p></div>`;
