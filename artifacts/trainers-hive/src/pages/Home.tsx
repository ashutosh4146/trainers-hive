...
import { ArrowRight, BookOpen, Briefcase, Users, Star, MapPin, Building, Activity, Clock } from "lucide-react";
...
export default function Home() {
  ...
  const { data: activityFeed, isLoading: activityLoading } = useListActivity({ query: { queryKey: getListActivityQueryKey() }});
    ...
    <div className="w-full flex flex-col">
      ...
      <section className="relative w-full py-20 md:py-32 lg:py-40 bg-slate-900 text-slate-50 overflow-hidden border-b border-primary/20">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 blur-3xl pointer-events-none transform translate-x-1/4">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            <Badge variant="outline" className="mb-6 border-primary/50 text-primary-foreground bg-primary/10 px-3 py-1 backdrop-blur-sm">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                <span className="font-medium text-foreground">
                                  ${req.budget.toLocaleString()} {req.feeType === "negotiable" && <span className="text-muted-foreground font-normal">(Negotiable)</span>}
                                </span>
                              </div>
                            </div>
                          </div>
                  ...
                  activityFeed.map((activity, index) => (
                    ...
                    >
                      ...
                      <Avatar className="h-10 w-10 shrink-0 z-10 border-2 border-background shadow-sm">
                        {activity.avatarUrl && <AvatarImage src={activity.avatarUrl} />}
