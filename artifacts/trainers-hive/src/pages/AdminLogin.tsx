...
import { ShieldCheck, Activity, Eye, EyeOff } from "lucide-react";
...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { sessionToken, adminEmail } = await res.json() as { sessionToken: string; adminEmail: string; user: unknown };
